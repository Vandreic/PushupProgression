...
const NOTIFICATION_SCENE: PackedScene = preload("res://components/notification/notification.tscn")

## The confirmation box scene.
const CONFIRMATION_BOX_SCENE: PackedScene = preload("res://components/confirmation_box/confirmation_box.tscn")


## Dictionary mapping scene names to their file paths.
var scene_dict: Dictionary = {
	"Main": "res://main.tscn",
	"OptionsMenu": "res://screens/options_menu/options_menu.tscn",
	"Settings": "res://screens/options_menu/options/settings_menu/settings_menu.tscn",
	"Appearance": "res://screens/options_menu/options/appearance_menu/appearance_menu.tscn",
	"ResetOptions": "res://screens/options_menu/options/reset_options_menu/reset_options_menu.tscn",
	"LogConsole": "res://screens/log_console/log_console.tscn",
	"ConfirmationBox": "res://components/confirmation_box/confirmation_box.tscn",
}
