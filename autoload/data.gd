...
const PROGRESS_BAR_ASSETS_FOLDER_PATH: String = "res://assets/progress_bar/"
var global_progress_bar_assets_folder_path: String = ProjectSettings.globalize_path("res://assets/progress_bar/")
...
var available_themes: Dictionary = {
	"light_blue": {
		...
		"progress_bar": {
			"under": preload("res://assets/progress_bar/light_blue/under.png"),
			"progress":preload("res://assets/progress_bar/light_blue/progress.png"),
			"over": preload("res://assets/progress_bar/light_blue/over.png")
		}
	},
	"light_blue_material_design": {
		...
		"progress_bar": {
			"under": preload("res://assets/progress_bar/light_blue_material_design/under.png"),
			"progress":preload("res://assets/progress_bar/light_blue_material_design/progress.png"),
			"over": preload("res://assets/progress_bar/light_blue_material_design/over.png")
		}
	},
	"dark_blue_material_design": {
		...
		"progress_bar": {
			"under": preload("res://assets/progress_bar/dark_blue_material_design/under.png"),
			"progress":preload("res://assets/progress_bar/dark_blue_material_design/progress.png"),
			"over": preload("res://assets/progress_bar/dark_blue_material_design/over.png")
		}
	}
}
